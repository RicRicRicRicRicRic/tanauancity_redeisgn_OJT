...
const documentsDatabase: Record<string, Array<{ id: number; title: string; date: string }>> = {
  ...
  '2022-INVITATION TO BID': [
    ...
    { id: 3, title: 'Supply & Delivery of Sump Pump & Controller', date: 'December 15, 2022' },
    { id: 4, title: 'Supply & Delivery of Laptop for Child Dev. Workers', date: 'December 10, 2022' },
    { id: 5, title: 'Supply and Delivery of Motor Vehicle (Animal Control Mobile)', date: 'December 05, 2022' },
    { id: 6, title: 'Supply and Delivery of Insecticides & Chemicals for Dengue Program', date: 'November 28, 2022' },
    { id: 7, title: 'Supply and Delivery of Medical and Laboratory Supplies for City Health Office', date: 'November 20, 2022' },
    { id: 8, title: 'Supply and Delivery of Business Plates', date: 'November 15, 2022' },
    { id: 9, title: 'Supply and Delivery of Veterinary Supplies', date: 'November 10, 2022' },
    { id: 10, title: 'Supply and Delivery of Drugs and Medicines for TB Control Program', date: 'November 05, 2022' },
    { id: 11, title: 'Supply and Delivery of Drugs and Medicines for CHO', date: 'October 28, 2022' },
    { id: 12, title: 'Supply & Delivery of Laboratory Supplies & Equipment', date: 'October 20, 2022' },
    { id: 13, title: 'EBPLs', date: 'October 15, 2022' },
    { id: 14, title: 'Christmas Decorations', date: 'October 10, 2022' },
    { id: 15, title: 'Various Computers', date: 'October 05, 2022' },
    { id: 16, title: 'Supply and Delivery of Sound System', date: 'September 28, 2022' },
    { id: 17, title: 'Supply and Delivery of Armchair', date: 'September 20, 2022' },
    { id: 18, title: 'Supply & Delivery of Responder\'s Equipment', date: 'September 15, 2022' },
    { id: 19, title: 'Supply & Delivery of Grocery', date: 'September 10, 2022' },
    { id: 20, title: 'Supply and Delivery of Tempered Glass Board', date: 'September 05, 2022' },
    { id: 21, title: 'Supply and Delivery of Drugs and Med for Maternal Health Program', date: 'August 28, 2022' },
    { id: 22, title: 'Supply and Delivery of Motor Vehicle for Office of the City Vice Mayor', date: 'August 20, 2022' },
    { id: 23, title: 'Supply and Delivery of Furniture & Fixture for Office of the City Mayor', date: 'August 15, 2022' },
    { id: 24, title: 'Supply and Delivery of Live Animals for Dispersal', date: 'August 10, 2022' },
    { id: 25, title: 'Supply & Delivery of Drugs & Med for CHO (3rd qtr) Re-Bid', date: 'August 05, 2022' },
    { id: 26, title: 'Supply and Delivery of Dugs & Med & Medical Supplies for Rabies Control Program (Re-Bid)', date: 'July 28, 2022' },
    { id: 27, title: 'Supply and Delivery of Flu Vaccine (Re-Bid)', date: 'July 20, 2022' },
    { id: 28, title: 'Invitation to Bid - Municipal Hall Upgrades', date: 'March 10, 2022' },
  ],
  '2022-BAC RESOLUTION': [
    ...
    { id: 3, title: 'Supply and Delivery of Drugs and Medicines ofr Sambat and Pagaspas Birthing Homes', date: 'November 28, 2022' },
    { id: 4, title: 'Supply and Delivery of Dump Truck', date: 'November 15, 2022' },
    { id: 5, title: 'Supply and Delivery of Medical & Laboratory Supplies for CHO', date: 'November 05, 2022' },
    { id: 6, title: 'Supply and Delivery of Rice and Sticker Provision of Welfare Goods Assistance for the poor families affected', date: 'October 20, 2022' },
    { id: 7, title: 'BAC Resolution No. 042 - Procurement of Heavy Equipment', date: 'August 10, 2022' },
  ],
  '2022-NOTICE TO PROCEED': [
    { id: 1, title: 'Supply and Delivery of Armchair for Various Schools', date: 'December 20, 2022' },
    { id: 2, title: 'Supply and Delivery of Assorted Groceries in Christmas Design', date: 'December 15, 2022' },
    { id: 3, title: 'Supply and Delivery of Drugs and Medicines for Sambat and Pagaspas Birthing Homes', date: 'November 28, 2022' },
    { id: 4, title: 'Supply and Delivery of Dump Truck', date: 'November 15, 2022' },
    { id: 5, title: 'Supply and Delivery of Laboratory Supplies for CHO', date: 'November 05, 2022' },
    { id: 6, title: 'Supply and Delivery of Rice and Sticker provision of welfare goods assistance for the poor families affected', date: 'October 20, 2022' },
    { id: 7, title: 'Notice to Proceed - Municipal Plaza Lighting', date: 'June 14, 2022' },
  ],
  '2022-NOTICE OF AWARD': [
    { id: 1, title: 'Supply and Delivery of Rice and Sticker Provision of Welfare Goods Assistance for the poor families affected', date: 'December 20, 2022' },
    { id: 2, title: 'Supply and Delivery of Medical & Laboratory Supplies for CHO', date: 'December 15, 2022' },
    { id: 3, title: 'Supply and Delivery of Dump Truck', date: 'November 28, 2022' },
    { id: 4, title: 'Supply and Delivery of Drugs and Medicines for Sambat and Pagaspas Birthing Homes', date: 'November 15, 2022' },
    { id: 5, title: 'Supply and Delivery of Backhoe Loader', date: 'November 05, 2022' },
    { id: 6, title: 'Supply and Delivery of Assorted Groceries in Christmas Design', date: 'October 20, 2022' },
    { id: 7, title: 'Supply and Delivery of Armchair for Various School', date: 'October 10, 2022' },
  ],
  ...
  '2022-FIRST QUARTER': [
    ...
    { id: 5, title: 'Quarterly Statement of Cash Flow (QSCF)', date: 'April 10, 2022' },
    { id: 6, title: 'SEF Utilization Fund (SEF)', date: 'April 08, 2022' },
    { id: 7, title: 'Trust Fund Utilization (PDAF)', date: 'April 05, 2022' },
    { id: 8, title: 'Unliquidated Cash Advances (UCA)', date: 'April 01, 2022' },
  ],
  '2022-SECOND QUARTER': [
    ...
    { id: 3, title: 'Bid Results on Civil Works, Goods & Services, Consulting Services', date: 'July 15, 2022' },
    { id: 4, title: 'Human Resource Complement (ManCom)', date: 'July 12, 2022' },
    { id: 5, title: 'Quarterly Statement of Cash Flow (QSCF)', date: 'July 10, 2022' },
    { id: 6, title: 'SEF Utilization Fund (SEF)', date: 'July 08, 2022' },
    { id: 7, title: 'Trust Fund Utilization (PDAF)', date: 'July 05, 2022' },
    { id: 8, title: 'Unliquidated Cash Advances (UCA)', date: 'July 01, 2022' },
  ],
  '2022-THIRD QUARTER': [
    { id: 1, title: '20% Component of the IRA Utilization (IRAU)', date: 'October 20, 2022' },
    { id: 2, title: 'LDRRM Utilization Fund (LDRRMFU)', date: 'October 18, 2022' },
    { id: 3, title: 'Bid Results on Civil Works, Goods & Services, Consulting Services', date: 'October 15, 2022' },
    { id: 4, title: 'Human Resource Complement (ManCom)', date: 'October 12, 2022' },
    { id: 5, title: 'Quarterly Statement of Cash Flow (QSCF)', date: 'October 10, 2022' },
    { id: 6, title: 'SEF Utilization Fund (SEF)', date: 'October 08, 2022' },
    { id: 7, title: 'Trust Fund Utilization (PDAF)', date: 'October 05, 2022' },
    { id: 8, title: 'Unliquidated Cash Advances (UCA)', date: 'October 01, 2022' },
  ],
  '2022-FOURTH QUARTER': [
    { id: 1, title: '20% Component of the IRA Utilization (IRAU)', date: 'January 20, 2022' },
    { id: 2, title: 'LDRRM Utilization Fund (LDRRMFU)', date: 'January 18, 2022' },
    { id: 3, title: 'Bid Results on Civil Works, Goods & Services, Consulting Services', date: 'January 15, 2022' },
    { id: 4, title: 'Human Resource Complement (ManCom)', date: 'January 12, 2022' },
    { id: 5, title: 'Quarterly Statement of Cash Flow (QSCF)', date: 'January 10, 2022' },
    { id: 6, title: 'SEF Utilization Fund (SEF)', date: 'January 08, 2022' },
    { id: 7, title: 'Trust Fund Utilization (PDAF)', date: 'January 05, 2022' },
    { id: 8, title: 'Unliquidated Cash Advances (UCA)', date: 'January 02, 2022' },
    { id: 9, title: 'Annual Procurement Plan 2023', date: 'January 15, 2022' },
    { id: 10, title: 'Annual Budget Report 2023', date: 'January 15, 2022' },
    { id: 11, title: 'Bid results 4Q 2022', date: 'January 15, 2022' },
    { id: 12, title: 'Annual Statement of Indebtedness, Payments and Balances (SIPB)', date: 'January 15, 2022' },
    { id: 13, title: 'Final-Consolidated-2022-GAD-Accomplishment-Report', date: 'January 25, 2022' },
    { id: 14, title: 'STATEMENT OF RECEIPTS AND EXPENDITURES CY 2022', date: 'January 30, 2022' },
  ],
  ...
  '2025-FIRST QUARTER': [
    ...
    { id: 3, title: 'Consolidated Quarterly Report on Government Projects, Programs or Activities', date: 'April 15, 2025' },
    { id: 4, title: 'Unliquidated Cash Advances', date: 'April 12, 2025' },
    { id: 5, title: 'Statement of Receipts and Expenditures', date: 'April 10, 2025' },
    { id: 6, title: 'Statement of Indebtedness, Payments and Balances (SIPB)', date: 'April 08, 2025' },
    { id: 7, title: 'Special Education Fund Utilization', date: 'April 05, 2025' },
    { id: 8, title: 'Statement of Cash Flows', date: 'April 03, 2025' },
    { id: 9, title: 'Human Resource Complement', date: 'April 02, 2025' },
    { id: 10, title: 'Consulting Services Bid-Out', date: 'April 01, 2025' },
    { id: 11, title: 'Local Disaster Risk Reduction and Management Fund Utilization', date: 'April 01, 2025' },
  ],
  '2025-SECOND QUARTER': [
    { id: 1, title: 'Utilization of the 20% of the National Tax Allotment', date: 'July 20, 2025' },
    { id: 2, title: 'Unliquidated Cash Advances', date: 'July 18, 2025' },
    { id: 3, title: 'Consolidated Quarterly Report on Government Projects, Programs or Activities', date: 'July 15, 2025' },
    { id: 4, title: 'Statement of Receipts and Expenditures', date: 'July 12, 2025' },
    { id: 5, title: 'Statement of Indebtedness, Payments and Balances (SIPB)', date: 'July 10, 2025' },
    { id: 6, title: 'Special Education Fund Utilization', date: 'July 08, 2025' },
    { id: 7, title: 'Statement of Cash Flows', date: 'July 05, 2025' },
    { id: 8, title: 'Human Resource Complement', date: 'July 03, 2025' },
    { id: 9, title: 'Local Disaster Risk Reduction and Management Fund Utilization', date: 'July 02, 2025' },
    { id: 10, title: 'Consulting Services Bid-Out', date: 'July 01, 2025' },
  ],
  '2025-THIRD QUARTER': [
    { id: 1, title: 'Utilization of the 20% of the National Tax Allotment', date: 'October 20, 2025' },
    { id: 2, title: 'Unliquidated Cash Advances', date: 'October 18, 2025' },
    { id: 3, title: 'Consolidated Quarterly Report on Government Projects, Programs or Activities', date: 'October 15, 2025' },
    { id: 4, title: 'Statement of Receipts and Expenditures', date: 'October 12, 2025' },
    { id: 5, title: 'Statement of Indebtedness, Payments and Balances (SIPB)', date: 'October 10, 2025' },
    { id: 6, title: 'Special Education Fund Utilization', date: 'October 08, 2025' },
    { id: 7, title: 'Statement of Cash Flows', date: 'October 05, 2025' },
    { id: 8, title: 'Human Resource Complement', date: 'October 03, 2025' },
    { id: 9, title: 'Local Disaster Risk Reduction and Management Fund Utilization', date: 'October 02, 2025' },
    { id: 10, title: 'Civil Works, Goods & Services Bid-Out', date: 'October 01, 2025' },
  ],
  '2025-FOURTH QUARTER': [
    { id: 1, title: 'Utilization of the 20% of the National Tax Allotment', date: 'January 20, 2026' },
    { id: 2, title: 'Consolidated Quarterly Report on Government Projects, Programs or Activities', date: 'January 18, 2026' },
    { id: 3, title: 'Unliquidated Cash Advances', date: 'January 15, 2026' },
    { id: 4, title: 'Statement of Indebtedness, Payments and Balances (SIPB)', date: 'January 12, 2026' },
    { id: 5, title: 'Special Education Fund Utilization', date: 'January 10, 2026' },
    { id: 6, title: 'Statement of Cash Flows', date: 'January 08, 2026' },
    { id: 7, title: 'Human Resource Complement', date: 'January 05, 2026' },
    { id: 8, title: 'Local Disaster Risk Reduction and Management Fund Utilization', date: 'January 03, 2026' },
    { id: 9, title: 'Consulting Services Bid-Out', date: 'January 02, 2026' },
    { id: 10, title: 'Supplemental Procurement Plan (SPP)', date: 'January 15, 2026' },
    { id: 11, title: 'Annual Gender and Development (GAD) Accomplishment Report 2025', date: 'January 20, 2026' },
    { id: 12, title: 'Annual Procurement Plan 2026', date: 'January 15, 2026' },
    { id: 13, title: '2026 Annual Budget', date: 'January 15, 2026' },
  ]
}

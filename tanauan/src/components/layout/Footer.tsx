...
const getInTouch = [
  { label: 'Talisay - Tanauan Rd, Tanauan, 4232 Batangas', href: '#', icon: LocationIcon },
  { label: '(043) 728-9800', href: '#', icon: PhoneIcon },
  { label: 'info@tanauancity.gov.ph', href: 'mailto:info@tanauancity.gov.ph', icon: EmailIcon },
]

      ...
      <section className="relative w-full h-[480px] md:h-[560px] lg:h-[497px] overflow-hidden mt-28 md:mt-31">
        ...
        <div className="relative z-40 h-full max-w-7xl mx-auto px-6 sm:px-10 md:px-14 flex items-center">
          <div className="max-w-xl text-white pt-4">
            ...
            {/* Top Pill Badge */}
            <div className="inline-flex items-center gap-2 bg-white/15 backdrop-blur-md border border-white/20 text-white text-xs font-medium px-4 py-1.5 rounded-full uppercase tracking-widest mb-6 shadow-sm">
              Official Tourism Portal
            </div>

            {/* Main Title with Elegant Tracking & Shadow */}
            <h1 className="font-serif text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-light tracking-tight mb-4 drop-shadow-lg">
              TanaWE <span className="font-normal italic text-red-200">Tanauan</span>
            </h1>

            {/* Poetic Tagline */}
            <p className="text-base sm:text-lg md:text-xl font-light tracking-wider leading-relaxed text-red-100/90 border-l-2 border-red-400/60 pl-4 my-4 italic">
              Tanawin ang Ganda,
              <br />
              <span className="font-medium text-white italic">Damhin ang Diwa</span>
            </p>

            {/* Welcome Message */}
            <div className='md:mt-6'>
              <p className="mt-6 text-xs sm:text-sm uppercase tracking-[0.25em] font-semibold text-red-200/90">
      ...
      <section className="py-20 px-6 md:mt-20 sm:px-10 md:px-14 max-w-7xl mx-auto w-full bg-white">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <h2 className="font-serif text-3xl sm:text-4xl md:text-5xl font-light text-slate-900 tracking-tight mb-4">
            Explore <span className="font-normal text-[#7a0000]">Tanauan</span>
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          ...
          <div className="group bg-slate-50/60 rounded-2xl p-8 shadow-md hover:shadow-2xl transition-all duration-300 border border-slate-300 hover:border-[#7a0000]/50 flex flex-col justify-between hover:-translate-y-1">
            <div>
              <div className="w-14 h-14 rounded-2xl bg-red-50 flex items-center justify-center text-[#7a0000] mb-6 group-hover:bg-[#7a0000] group-hover:text-white transition-colors duration-300 shadow-sm">
            ...
            <div className="mt-6 pt-4 border-t border-slate-200/60 flex items-center text-xs font-semibold uppercase tracking-wider text-[#7a0000] group-hover:translate-x-1 transition-transform">
